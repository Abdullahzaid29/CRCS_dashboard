...
function exportxlsheet({data}) {
    const handleExport = () => {
      ...
      return (
  <button onClick={handleExport} className='mb-4 px-5 py-2 ml-20 border border-gray-200 text-sm flex rounded-lg bg-amber-500 text-white active:bg-amber-600 font-bold uppercase  text-center justify-items-center	'>
EXPORT
  </button>
