...
<Hometable1 data={hometable1_data} />
      ...
      <div className="grid grid-cols-1  bg-white shadow-sm mb-16 px-10 py-10 my-4 rounded">
        <Map />
      </div>
      <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-2 mx-4">
         ...
         <p class="text-center text-sm text-gray-500 my-10">
            &copy; 2023-2024 <a href="#" class="hover:underline" target="_blank">Abdullah_zaid</a>. All rights reserved.
         </p>
    </>
  );
}
